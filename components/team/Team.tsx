...
import image1 from "@/public/14.jpeg";
    ...
    <div>
      <div className={`md:px-12 px-2 py-12`}>
        ...
        <p className="text-slate-600 max-w-xl py-6 mb-3">
          Our team at Top Movez Uganda is a dedicated group of professionals
          with extensive experience in the moving industry. We are committed to
